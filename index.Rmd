...
Estos coeficientes sí indican cuanto aumentaría en promedio la probabilidad de ser voluntario, en este caso, cuando el predictor aumenta en una unidad. Sin embargo, recordemos que sabemos de antemano que no todos estos covariados son significativos. Veamos los intervalos de confianza  en la Tabla \@ref(tab:marginals-table):
